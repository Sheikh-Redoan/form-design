...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Submission failed. Please check the API endpoint.');
    }
    setIsLoading(false);
  };
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center ${
      darkMode ? 'bg-gradient-to-br from-[#670d10] to-[#092756]' : 'bg-gradient-to-br from-blue-50 to-blue-100'
    }`}>
      <button
        onClick={toggleTheme}
      ...
      <div className="container flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <form onSubmit={handleSubmit} className={`w-full max-w-md p-8 rounded-lg shadow-xl ${
